            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="mt-6 max-w-3xl mx-auto text-lg text-white/80">
                    ...
                    <div class="mt-10 max-w-2xl mx-auto">
                        <form action="search-results.php" method="GET" class="mt-10 max-w-2xl mx-auto flex flex-col sm:flex-row gap-2 bg-white/10 p-2 rounded-full border border-white/20">
                            <div class="relative w-full sm:w-48">
                                <select name="category" class="w-full bg-transparent text-white pl-4 pr-8 py-3 rounded-full appearance-none focus:outline-none">

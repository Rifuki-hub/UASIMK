                    ...
                    <section class="w-full md:w-3/4">
                        <div class="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <div class="flex flex-wrap text-sm text-gray-600 gap-x-4 mb-4">
                                <span><i class="fa fa-calendar mr-1"></i>08-Sep-2021</span>
                            ...
                            <!-- Gambar, Hapus aja buat halaman lain -->
                            <img src="https://i.imgur.com/qEtNptq.jpeg"
                                alt="Struktur Organisasi DJBC"
                                class="w-full mx-auto mb-6 rounded-md shadow">

                            <!-- Isi Artikel, Copas Isi Kesini Otomatis Dibikinin Paragraph -->
                            <div class="prose prose-blue max-w-none text-gray-800">
                                <p class="text-base text-justify">
                                    Detail Struktur Organisasi dapat dilihat
                                    <a
                                        href="https://repository.beacukai.go.id/download/2022/04/1fc9e457f09548b32169c26450119cda-bagan-kanpus-djbc.docx"
                                        target="_blank"
